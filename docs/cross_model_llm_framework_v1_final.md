...
- Decision sources:
  - `docs/llm_robust_eval_report_v3.csv` (ZS)
  - `docs/llm_robust_eval_report_v3_fs.csv` (FS)
  - `docs/llm_robust_eval_report_v3_fs_vs_zs.csv` (final profile choice)
...
- Registry source of truth: `docs/cross_model_policy_registry_v1.md`
