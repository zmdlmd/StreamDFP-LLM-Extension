...
\includepdf[pages=1,fitpaper=true,pagecommand={\thispagestyle{empty}}]{AIMS5790_Cover Sheet for Final Report.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.72\textwidth,height=\textheight]{../source-assets/New-Model Onboarding Workflow.png}
...
\url{https://github.com/zmdlmd/StreamDFP-LLM-Extension}. The repository
...
Unless otherwise noted, the figures in this report were produced through
AI-assisted workflows. The conceptual diagrams were created with AI
collaboration and then manually curated for layout and labeling, while
the quantitative figures were rendered programmatically from retained
experiment outputs with AI assistance in the scripting and formatting
process. The workbench snapshot in the Appendix is an actual interface
capture rather than an AI-generated image.
...
\begin{figure}
\centering
\includegraphics[width=0.72\textwidth,height=\textheight]{../source-assets/mc1 Failure-and-Repair Storyline.png}
...
\url{https://github.com/zmdlmd/StreamDFP-LLM-Extension}.
