...
- `prearff_grid_*.csv|md`: Phase3 grid summaries
- `llm_robust_eval_report*.csv|md`: merged evaluation reports
- `llm_vs_nollm_metrics_*.csv|md`: model-level metric comparisons
- `framework_v1_baseline_lock.csv`: baseline lock reference used by policy selection
